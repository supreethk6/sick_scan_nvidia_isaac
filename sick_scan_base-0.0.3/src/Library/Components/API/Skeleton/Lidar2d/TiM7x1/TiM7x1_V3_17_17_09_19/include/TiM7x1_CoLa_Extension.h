...
{
class TiM7x1_CoLaASerializer : public CoLaASerializer
{
public:
	TiM7x1_CoLaASerializer(){};
	~TiM7x1_CoLaASerializer(){};
...
namespace TiM7x1_V3_17_17_09_19_Skeleton
{
class TiM7x1_CoLaADeserializer : public CoLaADeserializer
{
public:
	TiM7x1_CoLaADeserializer(){};
	~TiM7x1_CoLaADeserializer(){};
...
namespace TiM7x1_V3_17_17_09_19_Skeleton
{
class TiM7x1_CoLaAProtocol : public CoLaAProtocol
{
public:
	TiM7x1_CoLaAProtocol(AddressingMode AddrMode,size_t txBufSize, size_t rxBufSize)
		:CoLaAProtocol(AddrMode, txBufSize, rxBufSize)
	{
		pSerializer_ = &Serializer_;
		pDeserializer_ = &Deserializer_;
	};
	~TiM7x1_CoLaAProtocol(){};
	private:
		TiM7x1_CoLaASerializer Serializer_;
		TiM7x1_CoLaADeserializer Deserializer_;
	};
...
namespace TiM7x1_V3_17_17_09_19_Skeleton
{
class TiM7x1_CoLaBSerializer : public CoLaBSerializer
{
public:
	TiM7x1_CoLaBSerializer(){};
	~TiM7x1_CoLaBSerializer(){};
...
namespace TiM7x1_V3_17_17_09_19_Skeleton
{
class TiM7x1_CoLaBDeserializer : public CoLaBDeserializer
{
public:
	TiM7x1_CoLaBDeserializer(){};
	~TiM7x1_CoLaBDeserializer(){};
...
namespace TiM7x1_V3_17_17_09_19_Skeleton
{
class TiM7x1_CoLaBProtocol : public CoLaBProtocol
{
public:
	TiM7x1_CoLaBProtocol(AddressingMode AddrMode,size_t txBufSize, size_t rxBufSize)
		:CoLaBProtocol(AddrMode, txBufSize, rxBufSize)
	{
		pSerializer_ = &Serializer_;
		pDeserializer_ = &Deserializer_;
	};
	~TiM7x1_CoLaBProtocol(){};
	private:
		TiM7x1_CoLaBSerializer Serializer_;
		TiM7x1_CoLaBDeserializer Deserializer_;
	};
